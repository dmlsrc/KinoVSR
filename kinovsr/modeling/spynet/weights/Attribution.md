...
the shared MLX SpyNet implementation in
[`kinovsr/modeling/vsr_blocks.py`](../../vsr_blocks.py)
...
[`spynet_stock_20210409.safetensors`](spynet_stock_20210409.safetensors) is converted from
