...
kinovsr weights convert basicvsr_plusplus_c64n7_8x1_300k_vimeo90k_bd_20210305-ab315ab1.pth \
...
output names must match [`net.py`](../net.py)'s `_VARIANTS`
(`basicvsrpp_<token>.safetensors`).
...
`decompress_track1`. Output names must match [`net.py`](../net.py)'s `_RESTORE_VARIANTS`
