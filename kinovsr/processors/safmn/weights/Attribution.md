...
redistributed under its license (see [README.md](README.md) beside this file for the downloads).
...
the author's release and convert locally (see [README.md](README.md) beside this file).
