...
Convert -- the output name must match [`net.py`](../net.py)'s `_VARIANTS` (e.g. x2plus ->
...
kinovsr weights convert RealESRGAN_x4plus.pth \
  -o kinovsr/processors/realesrgan/weights/realesrgan_x4plus.safetensors --strip-prefix ''
```
