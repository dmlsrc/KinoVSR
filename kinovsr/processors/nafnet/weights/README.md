...
Convert (output name must match [`net.py`](../net.py)'s `_VARIANTS`,
...
kinovsr weights convert NAFNet-GoPro-width64.pth \
  -o kinovsr/processors/nafnet/weights/nafnet_gopro_width64.safetensors --strip-prefix ''
```
