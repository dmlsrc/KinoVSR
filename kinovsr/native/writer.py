...
class AVWriter:
    ...
    def append_mlx_rgb(
        ...
        *,
        ...
        # (The graph builds lazily for every dtype MLX accepts, so there is
        # no eager conversion failure to classify separately - verified by
        # probing every payload class the shape gate admits.)
